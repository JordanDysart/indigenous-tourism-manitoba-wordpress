<section
    ...
    $chosen_operators = get_field('operators_to_display');
                    ...
                    <div class="block-map">
                        ...
                        <div class="block-map-content">
                            ...
                            <div class="block-map-content-open">
                                <p class="block-map-content-category"><?php echo esc_html($operator_category); ?>.</p>
                                <p class="block-map-content-region"><?php echo esc_html($operator_region); ?>..</p>
