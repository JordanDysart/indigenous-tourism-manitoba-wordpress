...
*/
    ...
    acf_register_block_type(array(
        ...
        'title'             => __('Custom Banner', 'itm_indigpro'),
        'description'       => __('A custom block with background, overlay, and content images.', 'itm_indigpro'),
        'render_template'   => './blocks/banner_block/banner_block.php',
        'category'          => 'widgets',
        'icon'              => 'format-image',
        'keywords'          => array('background', 'image', 'overlay'),
