# Audit Report: Member Benefits — Performance & Runtime
...
1. **SVG Vector Icons:** Use lightweight inline SVGs for benefit pillar graphics rather than CSS webfonts.
